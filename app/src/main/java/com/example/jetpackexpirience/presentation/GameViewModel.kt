...
import com.example.jetpackexpirience.data.GameRepositoryImpl
...
import com.example.jetpackexpirience.domain.usecases.GenerateQuestionUseCase
import com.example.jetpackexpirience.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(private val application: Application, private val level: Level) : ViewModel() {
    ...
    private fun startTimer() {
        timer = object : CountDownTimer(
            gameSettings.timeInSeconds * MILLIS_IN_SECONDS,
            MILLIS_IN_SECONDS
        ) {
